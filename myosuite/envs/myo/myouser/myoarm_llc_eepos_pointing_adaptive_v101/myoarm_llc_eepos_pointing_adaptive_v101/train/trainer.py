...
if __name__=="__main__":
  ...
  parser.add_argument('--nonvisual', action='store_true', help='do not render graphics and not provide visual feedback during training')
  ...
  # Initialise
  if args.nonvisual:
    simulator = Simulator.get(simulator_folder, render_mode=None)
  else:
