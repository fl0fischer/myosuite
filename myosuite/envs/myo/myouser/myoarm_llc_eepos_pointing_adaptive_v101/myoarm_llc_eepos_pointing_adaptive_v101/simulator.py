...
from .utils.mjx import mujoco_to_mjx
...
class Simulator(gym.Env):
  ...
  def _initialise(cls, config, simulator_folder, run_parameters):
    ...
    # Transfer to MJX (i.e., to GPU/TPU), if available
    model, data = mujoco_to_mjx(model, data)
